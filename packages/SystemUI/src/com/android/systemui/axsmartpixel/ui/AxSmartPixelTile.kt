...
class AxSmartPixelTile @Inject constructor(
    host: QSHost,
    ...
    private val dialogDelegateProvider: Provider<AxSmartPixelDialogDelegate>,
    ...
    override fun handleClick(expandable: Expandable?) {
        ...
        secureSettings.putIntForUser(
            AxSmartPixelSettings.KEY_ENABLED,
    ...
    override fun handleUpdateState(state: BooleanState, arg: Any?) {
        val enabled = if (arg is Boolean) {
            ...
            secureSettings.getIntForUser(
                AxSmartPixelSettings.KEY_ENABLED, 0, UserHandle.USER_CURRENT,
            ) == 1
        }
        state.value = enabled
