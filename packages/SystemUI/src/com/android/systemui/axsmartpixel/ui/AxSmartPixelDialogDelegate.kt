...
import com.android.systemui.axsmartpixel.domain.AxSmartPixelSettings.Companion.MAX_PERCENT
import com.android.systemui.axsmartpixel.domain.AxSmartPixelSettings.Companion.MIN_PERCENT
...
class AxSmartPixelDialogDelegate @Inject constructor(
    ...
    private fun SmartPixelDialogContent(dialog: SystemUIDialog) {
        ...
        PlatformTheme(isDarkTheme = cachedDarkTheme) {
            AlertDialogContent(
                title = { Text(stringResource(R.string.smart_pixels_dialog_title)) },
